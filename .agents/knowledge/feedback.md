...
- Reviewer clarified the customer-facing Salesforce OAuth account card names: v2 External Client App should be named `OAuth(ECA)` and legacy Connected App should be named `OAuth (Connected App - Legacy)`.
