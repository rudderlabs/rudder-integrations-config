...
const destinationList = {
  ...
  AZURE_DATALAKE: require('./AZURE_DATALAKE.json'),
  ...
  DELTALAKE: require('./DELTALAKE.json'),
  ...
  GCS_DATALAKE: require('./GCS_DATALAKE.json'),
  GOOGLEADS: require('./GOOGLEADS.json'),
  GOOGLE_OPTIMIZE: require('./GOOGLE_OPTIMIZE.json'),
  ...
  POST_AFFILIATE_PRO: require('./POST_AFFILIATE_PRO.json'),
  ...
  BQSTREAM: require('./BQSTREAM.json'),
};
